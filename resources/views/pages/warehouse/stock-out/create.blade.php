...
@section('content')
    <h1 class="text-2xl font-semibold">Add Stock Out</h1>
                ...
                <form action="{{ route('stock-out.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="reference_no" placeholder="Auto Generated"
                                class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm" disabled>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="created_by" placeholder="Ex: Agung"
                                class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="approved_by" placeholder="Ex: Budi"
                                class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="note" rows="3" class="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm"></textarea>
                        </div>
                    </div>
